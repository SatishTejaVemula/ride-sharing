...
const DriverSidebar = ({
    ...
    return (
        <>
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-slate-800/80 bg-slate-950 transition-transform duration-300 lg:translate-x-0 ${open
                        ? "translate-x-0"
                        : "-translate-x-full"
                    }`}
            >
                ...
                <div className="flex h-20 items-center justify-between border-b border-slate-800/80 px-6">
                    ...
                    <div>
                        <h1 className="text-xl font-black tracking-tight text-white">
                            RideFlow<span className="text-blue-500">.</span>
                        </h1>
                        ...
                        {navigation.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex w-full items-center gap-3 rounded-2xl px-3 py-3 text-sm font-medium transition ${item.active
