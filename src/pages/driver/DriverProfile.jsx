...
const DriverProfile = () => {
    ...
    const loadProfile = async () => {
        ...
        try {
            ...
            console.log("DRIVER PROFILE RESPONSE:", profile);
            console.log("DRIVER PROFILE IMAGE:", profile.profileImage);
    ...
    const handleImageChange = (event) => {
        ...
        console.log(
            "Uploading driver profile image:",
            file
        );
                ...
                <section className="overflow-hidden rounded-3xl border border-slate-800/80 bg-slate-900/50 shadow-xl shadow-black/10 backdrop-blur-xl">
                    ...
                    <div className="relative border-b border-slate-800/80 px-6 py-8 sm:px-8">
                        ...
                        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="rounded-2xl border border-slate-800 bg-slate-950/50 px-5 py-3">
